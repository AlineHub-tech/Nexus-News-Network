...
  </div>
        ...
        <div class="article"style="margin-bottom:5%">
            <h2>Dashboard y'Umwanditsi</h2>
<a href="article.php">➡Andika Inkuru Nshya📑</a><br><br>
<a href="tv.php">➡Andika Inkuru kuri NNN TV📺</a><br><br>
<a href="auther_view.php">➡Reba Inkuru Zawe🏪</a>
</div>
 <footer>
    <div class="soc">
