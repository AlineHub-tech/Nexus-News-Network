...
if (!$user) {
    die("Token ntabwo ikora cyangwa yararangiye.");
}
...
<form method="POST" class="article-form">
    <input type="password" name="password" placeholder="Password nshya" required>
    <button type="submit">Hindura Password</button>
</form>
<footer>
    <div class="soc">
