...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user) {
        ...
        // OHEREZA EMAIL (PHPMailer cyangwa mail())
        mail($email, "Password Reset", "Kanda hano kugirango usubize password yawe: $reset_link");

        echo "Ibaruwa yoherejwe kuri email yawe.";
    } else {
        echo "Email ntibonetse.";
    }
}
?>
<!DOCTYPE html>
...
<form method="POST" class="article-form">
    <input type="email" name="email" placeholder="Shyiramo email yawe" required>
    <button type="submit">Ohereza Reset Link</button>
</form>
<footer>
    <div class="soc">
