...
import Navbar from '../components/Navbar'; // Komezanya zo ubwazo
import Footer from '../components/Footer'; // Komezanya zo ubwazo
import '../styles/PrivacyPolicy.css'; // Hano niho style ziri


const translations = {
    // ... (translations data iraguma uko iri) ...
