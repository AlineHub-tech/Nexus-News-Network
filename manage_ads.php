...
$ads = $pdo->query("SELECT * FROM advertisements ORDER BY created_at DESC LIMIT 3")->fetchAll();
?>
...
<a href="ads.php"style="color:black;margin-top:-20%; margin-left:38%;">Ongeramo Advertisement yamagambo</a>
 <footer>
    <div class="soc">
